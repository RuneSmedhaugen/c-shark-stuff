...
public class BowlingAlleyService : BaseService
{
    ...
    {
        string query = "INSERT INTO BowlingAlleys (Name, Location, Review, Image, UserId) VALUES (@Name, @Location, @Review, @Image, @UserId)";
    ...
    {
        string query = "UPDATE BowlingAlleys SET Name = @Name, Location = @Location, Review = @Review, Image = @Image WHERE Id = @Id";
        ExecuteNonQuery(query, cmd =>
        {
